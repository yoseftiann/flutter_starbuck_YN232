...
class ItemGreen extends StatefulWidget {
  final Drink drink;
    const ItemGreen({required this.drink, Key? key}) : super(key: key);

  @override
  State<ItemGreen> createState() => _ItemGreenState();
}

class _ItemGreenState extends State<ItemGreen> {
  @override

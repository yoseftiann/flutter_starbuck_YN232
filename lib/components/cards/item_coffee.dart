...
class ItemCoffee extends StatefulWidget {
  final Drink drink;
    const ItemCoffee({required this.drink, Key? key}) : super(key: key);

  @override
  State<ItemCoffee> createState() => _ItemCoffeeState();
}

class _ItemCoffeeState extends State<ItemCoffee> {
  @override
